...
if (isset($_POST['submit'])) {
 ...
 $flag1= $_FILES["images"]['name'];
    ...
    move_uploaded_file($file_tem_loc,$file_store); 
          ...
          $query="INSERT INTO category(name, spec, des, image) VALUES ('$name','$spec','$description','$flag1')";
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Primary Category</h2>
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text"  id="whatsapp" class="form-control" name="spec" placeholder="Specifications" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input type="file" class="form-control" name="images" placeholder="image" required="" id="image">
                                                                </div>
                                                            </div>
                                                        </div>
