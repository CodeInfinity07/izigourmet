...
{  
  $id=$_POST['del_id'];
  $query="DELETE FROM flavour WHERE id='$id'";
  if(mysqli_query($conn, $query))  
  {  
   
    ?>
    <script type="text/javascript">
      alert('Flavour has been deleted successfully..');
      window.location.href = "flavour.php";
    </script>
    <?php
...
if (isset($_POST['submit'])) {
 $name=$_POST['name'];
          ...
          $query="INSERT INTO flavour(name) VALUES ('$name')";

          if (mysqli_query($conn, $query)) { 
           ?>
           <script type="text/javascript">
            alert('Flavour Add successfully');
            window.location.href = "flavour.php";
          </script>
          <?php
        }
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Add Flavour</h2>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add Flavour</h4>
                            </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Are You Sure You Want To Delete This Flavour?</p>
          </div>
          <form action="flavour.php" method="POST">
